#############################################
__author__ = "Rishabh_Pratap_Singh"                  #
__LinkedIn__ = "Rishabh_Pratap_Singh"                #
__Github__ = "Rishabh_Pratap_Singh"                  #
#############################################
...
def configurations():
    ...
    # Update the ChromeDriver path accordingly
    chrome_service = Service('C:/Users/iglgo/OneDrive/Desktop/Linkedin-Connection-Bot-Script1_gui/ChromeDriver/chromedriver.exe')
    driver = webdriver.Chrome(service=chrome_service, options=options)
    # The rest of your configurations function...
